...
[![Coverage Status](https://coveralls.io/repos/github/fiware/endpoint-auth-service/badge.svg?branch=initial-dev)](https://coveralls.io/github/fiware/endpoint-auth-service?branch=initial-dev)
